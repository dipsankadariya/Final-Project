        ...
        <div className="p-8 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-slate-400">or continue as guest</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-2 px-4 text-slate-700 hover:bg-slate-100 transition-colors text-sm font-medium"
          >
            Continue as Guest
          </button>
...
export function UserProfile({ user, onLogout }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={onLogout}
        className="text-xs px-3 py-1.5 rounded hover:bg-slate-100 text-slate-600 transition-colors whitespace-nowrap"
      >
        Logout
      </button>
    </div>
